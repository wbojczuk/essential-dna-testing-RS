  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.socialLinks}>
          <a href="https://www.facebook.com/profile.php?id=61568233932850" target="_blank" className={styles.socialLink}>
          ...
          <a href="https://www.instagram.com/essentialdnatesting/" target="_blank" className={styles.socialLink}>
          ...
          <aside>
            ...
            <aside>
              ...
              <ul className={styles.list}>
                ...
                <span className={styles.listItem}>Ancestry DNA</span>
